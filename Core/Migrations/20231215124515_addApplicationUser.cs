        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Company_States_StateId",
                        column: x => x.StateId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChemistId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Active = table.Column<bool>(type: "bit", nullable: false),
                    Deleted = table.Column<bool>(type: "bit", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_AspNetUsers_ChemistId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChemistId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    DosageInformation = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_AspNetUsers_ChemistId",
                        column: x => x.ChemistId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompanyBranches_Countries_CountryId",
                        column: x => x.CountryId,
                        principalTable: "Countries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    CompanyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ShowAllClientsInAllScheduleScreen = table.Column<bool>(type: "bit", nullable: false),
                    ShowAllStaffInAllScheduleScreen = table.Column<bool>(type: "bit", nullable: false),
                    ShowLeaveModule = table.Column<bool>(type: "bit", nullable: false),
                    ShowClockIn = table.Column<bool>(type: "bit", nullable: false),
                    ShowPayroll = table.Column<bool>(type: "bit", nullable: false),
                    ShowProject = table.Column<bool>(type: "bit", nullable: false),
                    ShowSchedule = table.Column<bool>(type: "bit", nullable: false),
                    Deleted = table.Column<bool>(type: "bit", nullable: false),
                    Active = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyBranches_CountryId",
                table: "CompanyBranches",
                column: "CountryId");
